...
commission_sz = 0.487/10000 # 上交所ETF的佣金/元
commission_sh = 0.45/10000  # 深交所ETF的佣金/元
commission_index = 0.23/10000 # 指数期货的佣金/元
commission_bond = 3           # 债券期货的每笔佣金/手
commission_multiplier = 3     # 佣金的乘数


# 存每只ETF代码对应的名字和佣金比例，债券ETF免佣金
ETF_dict = {
